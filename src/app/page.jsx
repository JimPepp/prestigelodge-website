  ...
  return (
    <>
      ...
      <section className="flex justify-center">
        <div class="max-w-screen-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div class="grid grid-cols-1 max-w-3xl gap-y-8 lg:items-center">
            <div class="mx-auto text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              <h2 class="text-3xl font-bold sm:text-4xl">
                How will you achieve your goals?
              </h2>

              <p class="mt-4 text-text text-xl">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
              <a
                class="block rounded-xl border border-amber-100 p-4 shadow-sm hover:border-amber-200 hover:ring-1 hover:ring-amber-200 focus:outline-none focus:ring"
                href="/contactus"
              >
                ...
                <h2 class="mt-2 text-2xl text-center font-bold sm:text-3xl">
                  Websites
                </h2>
              ...
              >
                ...
                <h2 class="mt-2 text-xl text-center font-bold sm:text-3xl">
                  Marketing
                </h2>
